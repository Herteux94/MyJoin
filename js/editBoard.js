  ...
  return `
    <div class="categoryHeader">
        ...
        <div class="inputWithIcon" onclick="technicalUserEdit(),  toggleCategoryEdit()">
            ...
            <img id="categoryDropdown" class="dropdownIcon" src="assets/img/arrow_drop_down.png" class="dropdownIcon">
        </div>
  ...
  return `
    <div class="subtasks">
        ...
        <div class="inputWithIcon">
            ...
            <img id="subTask" src="assets/img/Subtask's icons.png" class="dropdownIcon" onclick="changeIconsSubtaskEdit()">
        </div>
    </div>
